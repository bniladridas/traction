<p align="center">
  <img src="https://raw.githubusercontent.com/bniladridas/traction/main/.github/assets/thumbnail.png" alt="traction" width="100%">
</p>
...
Prototype renders from the real Metal renderer (Task 16 state).
...
├── AGENTS.md
├── docs/
│   ├── architecture.md      # current system map (Task 16 state)
